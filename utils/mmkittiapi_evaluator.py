...
class MMKITTIAPIEvaluator():
    """
    COCO AP Evaluation class.
    All the data in the val2017 dataset are processed \
    and evaluated by COCO API.
    """
    def __init__(self, model_type, data_dir0, data_dir1, img_size, confthre, nmsthre):
        """
        Args:
        ...
        self.dataset = MMKITTIDataset(model_type=model_type,
                                   data_dir0=data_dir0,
                                   data_dir1=data_dir1,
                                   img_size=img_size,
    ...
    def evaluate(self, model):
        ...
        # while True: # all the data in val2017
            ...
            # except StopIteration:
                # break
            img0, img1, _, info_img, id_ = batch
            ...
            with torch.no_grad():
                ...
                outputs = postprocess(
                    outputs, 3, self.confthre, self.nmsthre)
